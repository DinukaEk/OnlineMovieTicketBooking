          ...
          <div class="panel-body">
            <form action="process_registration.php" method="post" id="form1">
              ...
              <div class="form-group has-feedback">
                ...
                <?php $frm->validate("password", array("required", "label" => "Password", "min" => "6")); // Validating form using form builder written in form.php 
                ?>
                <span class="glyphicon glyphicon-lock form-control-feedback"></span>
              </div>
              <div class="form-group has-feedback">
                <input name="cpassword" type="password" size="25" placeholder="Re-Enter Password" class="form-control" placeholder="Password" />
